    ...
    <div className="p-6 bg-white rounded-lg shadow-sm mt-3">
      ...
      <div className="mb-2">
        <div className="flex justify-between items-center mb-2">
          <h2 className="text-2xl font-bold text-gray-800 font-montserrat">Division Management</h2>
          <div className="relative">
            <MagnifyingGlassIcon className="w-5 h-5 absolute left-3 top-1/2 transform -translate-y-1/2 text-gray-400 font-montserrat" />
            <Input
        ...
        <div className="flex justify-between items-center gap-4 flex-wrap">
          <div className="flex items-center gap-4">
            <Select value={recordsPerPage} onValueChange={(value) => setRecordsPerPage(value)}>
              <SelectTrigger className="w-[180px] bg-white border-gray-200 shadow-sm font-montserrat">
        ...
        <Table>
          <TableHeader>
            <TableRow className="bg-gray-50">
              ...
              <TableHead className="py-4 text-center px-6 text-gray-700 font-semibold border-b border-r font-montserrat">Division Name</TableHead>
            ...
            {loading ? (
              ...
              divisions.map((division, index) => (
                ...
                >
                  ...
                  <TableCell className="py-4 px-6 text-center border-r text-gray-700 font-montserrat">{division.name}</TableCell>
                  <TableCell className="py-4 px-6 text-center border-r text-gray-700 font-montserrat">{division.createdAt}</TableCell>
